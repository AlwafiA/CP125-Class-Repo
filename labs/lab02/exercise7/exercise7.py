def check_collision(x1, y1, w1, h1, x2, y2, w2, h2):
    ...
    # 2. Check for NO vertical overlap (assuming y-axis increases downwards)
    no_vertical_overlap = (y1 + h1 <= y2) or (y1 >= y2 + h2)

    # If there is NO overlap either horizontally OR vertically, they are NOT colliding.
    if no_horizontal_overlap or no_vertical_overlap:
        return False
    else:
        # If there is both horizontal AND vertical overlap, they ARE colliding.
        return True
